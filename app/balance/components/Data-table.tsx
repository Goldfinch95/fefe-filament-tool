...
function DragHandle({ id }: { id: number }) {
  ...
  return (
    ...
    >
      ...
      <span className="sr-only">Agarra para reordenar</span>
    </Button>
  )
}
...
},
{
    ...
    header: "Vendedor",
    cell: ({ row }) => {
      const isAssigned = row.original.seller !== "Vendedor"

      if (isAssigned) {
        return row.original.seller
      }
  ...
  return (
    ...
    >
      {row.getVisibleCells().map((cell) => (
        <TableCell key={cell.id } className="bg-black/50 text-white">
...
export function DataTable({
  ...
  return (
    <Tabs
      ...
      className="w-full flex-col justify-start  dark text-white"
    >
        ...
        <div className="flex flex-col gap-4 overflow-y-auto px-4 text-sm">
          ...
          <form className="flex flex-col gap-4 ">
            ...
            <div className="flex flex-col gap-3">
              ...
              <Select defaultValue={item.client}>
